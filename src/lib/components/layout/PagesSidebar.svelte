<script lang="ts">
	...
	let pages = [
		{
			page: 'Home',
			route: '/dashboard/sitecontent/home',
			image: '/ss1.png'
		},
		{
			page: 'Gallery',
			route: '/dashboard/sitecontent/gallery',
			image: '/ss2.png'
		},
		{
			page: 'Services',
			route: '/dashboard/sitecontent/services',
			image: '/ss3.png'
		},
		{
			page: 'About Us',
			route: '/dashboard/sitecontent/aboutus',
			image: '/ss4.png'
		},
		{
			page: 'Blog',
			route: '/dashboard/sitecontent/blog',
			image: '/ss5.png'
		},
	];
</script>
